        ...
        for x in self.data:
            for i in x:
                if i > 0:
                    c += 1
            #c += x.count(0)
        return c#sum([x.count(item) for x in self.data])
...
class GameStateData:
    ...
    def __init__(self, prevState=None):
        ...
        if prevState != None:
            ...
            self.ghostEatenRecord = prevState.ghostEatenRecord
    ...
    def deepCopy(self):
        ...
        self.ghostEatenRecord = self.ghostEatenRecord
        return state
